...
class TrackingStep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_ON_A_WAY_TO_CONSIGNEE = 'ON_A_WAY_TO_CONSIGNEE';
    ...
    public const STATUS_NO_STATUS = 'NO_STATUS';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_UNLOADED,
            self::TYPE_ON_A_WAY_TO_CONSIGNEE,
            self::TYPE_DELIVERED,
        ];
    }
    ...
    */
     ...
     * Sets sequence
     *
     * @param float|null $sequence Sequence of the tracking step.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Type of tracking step.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string $code Status code of the step.
     *
     * @return self
     */
