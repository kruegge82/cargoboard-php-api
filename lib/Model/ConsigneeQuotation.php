...
/**
 * ConsigneeQuotation Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\cargoboard
 * @author   OpenAPI Generator team
 ...
 */
class ConsigneeQuotation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsigneeQuotation';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_private_customer', $data ?? [], null);
        $this->setIfExists('wants_contact_before_delivery', $data ?? [], null);
        $this->setIfExists('wants_phone_call_from_driver_before_delivery', $data ?? [], null);
        $this->setIfExists('wants_delivery_without_consignee_presence', $data ?? [], null);
    ...
    */
     ...
     * Sets reference
     *
     * @param string|null $reference Reference number of the consignee. Driver will use this reference to notify the consignee.
     *
     * @return self
     */
