 ...
 */
class OrderId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderId';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Id of order related to Easybill Invoice.
     *
     * @return self
     */
